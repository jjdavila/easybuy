...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<!-- Styles -->
		<link rel="stylesheet" href="css/frenzy-orange.css">  <link rel="stylesheet" href="css/easy507.css">  <link rel="stylesheet" href="css/easy507.css">
	...
	<body>
							...
							<div class="content-inner">
								<article>
									<div class="article-header">
										<h1 class="title">Ni&ntilde;os, Bebes, Juguetes..</h1>
										
										<div class="separator"></div>
									</div>
									<div class="article-thumbnail">
											<a href="#"><img  class="beneficio" src="img/assets/507/tiendaninos.jpg"/></a>
        ...
        <tr>
            <td>
                <a href="http://hasbro.com">hasbro.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://babystyle.com">babystyle.com</a></td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                &nbsp;<a href="http://fao.com">fao.com</a></td>
        </tr>
        <tr>
            <td>
                <a href="http://disneystore.com">disneystore.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://etoys.com">etoys.com</a></td>
        </tr>
        <tr>
            <td>
                <a href="http://videogamecentral.com">videogamecentral.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://barbie.com">barbie.com</a></td>
        </tr>
        <tr>
            <td>
                <a href="http://babiesrus.com">babiesrus.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://toysrus.com">toysrus.com</a></td>
        </tr>
        <tr>
            <td>
                <a href="http://lego.com">lego.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://carters.com">carters.com</a></td>
        </tr>
        <tr>
            <td>
                <a href="http://babycenter.com">babycenter.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://trollandtoad.com">trollandtoad.com</a></td>
        </tr>
        <tr>
            <td>
                <a href="http://kbtoys.com">kbtoys.com</a></td>
            <td style="width: 51px">
            </td>
            <td>
                <a href="http://yugiohmint.com">yugiohmint.com</a></td>
        </tr>
    </table>

										...
										<div class="row-fluid">
											...
											<div class="span6">
												    ...
												    <fieldset>
												    	...
												    	<input type="text" name="contact_name" id="contact_name" class="input-xlarge" placeholder="Ingrear Nombre…">
												    </fieldset>

												    <fieldset>
												    	<label class="formatos_de_textos">Correo Electronico</label>
												    	<input type="email" id="contact_email" name="contact_email" class="input-xlarge" placeholder="Ingresar correo…">
												    </fieldset>												  

												    <fieldset>
												    	<label class="formatos_de_textos">Mensaje:</label>
												    	<textarea id="contact_messages" name="contact_messages" rows="8" class="input-xxlarge" placeholder="Ingresar mensaje…"></textarea>
												    </fieldset>

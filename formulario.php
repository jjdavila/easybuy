							...
							<div class="content-inner">
								<article>
									<div class="article-header">
										<h1 class="title">Registro de Azafata</h1>
										
										<div class="separator"></div>
									</div>
									<div class="article-thumbnail">
											<!--<a href="#"><img  class="beneficio" src="img/assets/507/cotizar.jpg"/></a>-->
										<div class="caption">formulario</div>
									</div>
									<div class="article-content">								
									
										<div class="post-single" id="post">																																		
										<h3 class="post-lead">Ingresar publicidad de azafatas.</h3>
										<div class="row-fluid">
										 <form name="crear" id="crear"  method="post" enctype="multipart/form-data">
											<div class="span6">												
												    <fieldset>
												    	<label class="formatos_de_textos">Nombre:</label>
												    	<input type="text" name="txtnombres" class="input-xlarge" placeholder="Escribir Nombre…" id="txtnombres">
												    </fieldset>
													<fieldset>
												    	<label class="formatos_de_textos">Apellido:</label>
												    	<input type="text" name="txtapellidos" class="input-xlarge" placeholder="Escribir apellido…" id="txtapellidos">
												    </fieldset>
												    <fieldset>
												    	<label class="formatos_de_textos">Edad de la Modelo:</label>
												    	<input type="text" name="txtedad" class="input-xlarge" placeholder="Escribir edad" id="txtedad">
												    </fieldset>
												    ...
												    <fieldset>
												    	...
												    	<input type="email" name="contact_email" class="input-xlarge" placeholder="Correo electronico…"> -->
												    	<label class="formatos_de_textos">Seleccione una imagen:</label>
														<input type="file" name="uplimagen" id="uplimagen" size="35"/>
														
												    </fieldset>		

												<!-- 	<label class="formatos_de_textos">Usuario:</label>
												    	<input type="text" name="contact_user" class="input-xlarge" placeholder="…">
												    </fieldset> -->																								
												    <fieldset>
												    	<label class="formatos_de_textos">Breve descripci&oacute;n de:</label>
												    	<textarea name="txtmensajes" rows="8" class="input-xxlarge" placeholder="Descripción de la azafata…" id="txtmensajes"></textarea>
												    </fieldset>

												   
												     <button name="btnenviar" id="btnenviar" type="submit" class="pull-right btn btn-flat" onclick = "this.form.action = 'php/crear_azafata.php'">Enviar</button>
